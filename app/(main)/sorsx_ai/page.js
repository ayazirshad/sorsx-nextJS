...
const SorsxAi = () => {
  ...
  return (
    <div id="sorsx-ai-page">
      {/* <!-- hero  --> */}
      <section className="text-center hero-section">
        <div className="container">
          <div className="page-name-wrapper flex-center">
            <p className="page-name-text">SorsX AI</p>
          </div>
          <h1 className="main-heading">
            <span className="first-word">AI Recruiting Agents</span>
            <span className="second-word">for</span>
            <br />
      ...
      <section className="info-section feature-info-section padding-y">
        <div className="container flex-between gap-10">
          <div className="info-content">
            <div className="page-name-text">For Hiring Teams</div>
      ...
      <section className="stop-paying-section padding-y">
        ...
        <div className="container text-center z-10">
          ...
          <h3 className="section-heading white-text-1">
          ...
          <div className="cta-input-group mt-3">
            <input
              type="email"
              placeholder="Email"
